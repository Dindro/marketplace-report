...
export type ReportActionType = 'delivery' | 'sale' | 'sale-correct' | 'return-correct' | 'delivery-return' | 'return' | 'marriage' | 'lost-product' | 'reversal' | 'reversal-return' | 'fines' | 'common-fines' | 'ad' | 'storage' | 'underpayment' | 'unkown';
