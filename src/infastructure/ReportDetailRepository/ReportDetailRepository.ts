    ...
    private convertTableDataToActionList(data: any): ReportAction[] {
        ...
        if (Array.isArray(data)) {
            ...
            for (const row of data) {
                ...
                if (type === 'storage' || type === 'retention' || type === 'organization-fines' || type === 'recalculation-paid-acceptance') {
                    continue;
                ...
                } else if (type === 'delivery-correct' && typeDocument !== 'unkown') {
                    type = 'unkown';
                    ...
                    type = 'unkown';
                } else if (type === 'payment-shipping-cost/storage-operation') {
                    if (typeDocument !== 'unkown') {
                        type = 'unkown';
                    } else {
                        type = 'payment-shipping-cost';
                    }
